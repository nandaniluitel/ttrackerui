      ...
      <div className="flex items-start justify-between gap-2">
        <div className="flex items-center gap-2">
          {showHandle ? (
            <button
              type="button"
              className="inline-flex h-8 w-8 cursor-grab items-center justify-center rounded-md border bg-white text-muted-foreground hover:bg-muted/30"
...
export default function BoardPage() {
  ...
  const activeSprint = useMemo(() => {
    if (!selectedSprint || selectedSprint.sprintId == null) return null;
    return sprints.find((s) => s.id === selectedSprint.sprintId) ?? null;
  ...
  return (
    <div className="space-y-6">
      ...
      {viewing && (
        <Sheet open modal={false} onOpenChange={(o) => !o && setViewing(null)}>
          <SheetContent
            side="right"
            className="w-full p-0 sm:max-w-[520px] z-40"
          >
            <div className="flex h-full flex-col">
              ...
              <div className="flex-1 space-y-4 overflow-y-auto px-6 py-4">
                <div className="space-y-2">
                  ...
                  <div className="whitespace-pre-wrap rounded-lg border p-3 text-sm text-muted-foreground">
